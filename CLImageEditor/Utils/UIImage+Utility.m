...
//  UIImage+Utility.m
//
//  Created by Kevin Siml - Appzer.de on 2015/05/17.
...
- (UIImage*)sepiaImage
{
    ...
    [stillImageFilter setIntensity:1.0];
    UIImage *newImage = [stillImageFilter imageByFilteringImage:self];
    return newImage;
}
...
- (UIImage*)bwImage
{
    ...
    [stillImageFilter setThreshold:0.5];
    UIImage *newImage = [stillImageFilter imageByFilteringImage:self];
    return newImage;
}
...
- (UIImage*)posterImage
{
    ...
    [filter setDefaults];
    [filter setValue:[NSNumber numberWithFloat:4] forKey:@"inputLevels"];
