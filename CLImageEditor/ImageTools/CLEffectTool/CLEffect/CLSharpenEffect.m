...
#import "CLSharpenEffect.h"

#import "UIView+Frame.h"

@implementation CLSharpenEffect
{
...
{
    return NSLocalizedStringWithDefaultValue(@"CLSharpenEffect_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Sharpen", @"");
}
...
- (UIImage*)applyEffect:(UIImage*)image
{
    ...
    [stillImageFilter setSharpness:_shadowSlider.value];
...
{
    _shadowSlider = [self sliderWithValue:0.5 minimumValue:0 maximumValue:2];
