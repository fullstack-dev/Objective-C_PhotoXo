//
//  CLBlackWhiteEffect.m
//
//  Created by Kevin Siml - Appzer.de on 2015/10/23.
//  Copyright (c) 2015 Appzer.de. All rights reserved.
//

#import "CLBlackWhiteEffect.h"

#import "UIView+Frame.h"

@implementation CLBlackWhiteEffect
{
...
{
    return NSLocalizedStringWithDefaultValue(@"CLBlackWhiteEffect_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Black & White", @"");
}
...
- (UIImage*)applyEffect:(UIImage*)image
{
    ...
    [stillImageFilter setThreshold:_shadowSlider.value];
...
{
    _shadowSlider = [self sliderWithValue:0.5 minimumValue:0 maximumValue:1];
