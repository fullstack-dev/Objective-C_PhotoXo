//
//  CLSketchHardEffect.m
//
//  Created by Kevin Siml - Appzer.de on 2015/10/23.
//  Copyright (c) 2015 Appzer.de. All rights reserved.
//

#import "CLSketchHardEffect.h"

#import "UIView+Frame.h"

@implementation CLSketchHardEffect
{
...
{
    return NSLocalizedStringWithDefaultValue(@"CLSketchHardEffect_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Sketch Hard", @"");
}
...
- (UIImage*)applyEffect:(UIImage*)image
{
    ...
    [stillImageFilter setEdgeStrength:_shadowSlider.value];
...
{
    _shadowSlider = [self sliderWithValue:2 minimumValue:0.1 maximumValue:3];
