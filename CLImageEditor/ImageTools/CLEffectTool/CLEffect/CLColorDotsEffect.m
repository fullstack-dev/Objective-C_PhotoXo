...
#import "CLColorDotsEffect.h"

#import "UIView+Frame.h"

@implementation CLColorDotsEffect
{
...
{
    return NSLocalizedStringWithDefaultValue(@"CLColorDotsEffect_DefaultTitle", nil, [CLImageEditorTheme bundle], @"ColorDots", @"");
}
...
- (UIImage*)applyEffect:(UIImage*)image
{
    ...
    [stillImageFilter setFractionalWidthOfAPixel:_shadowSlider.value];
    [stillImageFilter setDotScaling:_radiusSlider.value];
...
{
    _shadowSlider = [self sliderWithValue:0.05 minimumValue:0 maximumValue:0.2];
    _shadowSlider.superview.center = CGPointMake(_containerView.width/2, _containerView.height-30);
    
    _radiusSlider = [self sliderWithValue:0.9 minimumValue:0 maximumValue:1];
