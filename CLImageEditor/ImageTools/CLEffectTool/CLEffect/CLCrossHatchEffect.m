//
//  CLCrossHatchEffect.m
//
//  Created by Kevin Siml - Appzer.de on 2015/10/23.
//  Copyright (c) 2015 Appzer.de. All rights reserved.
//

#import "CLCrossHatchEffect.h"

#import "UIView+Frame.h"

@implementation CLCrossHatchEffect
{
...
{
    return NSLocalizedStringWithDefaultValue(@"CLCrossHatchEffect_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Cross Hatch", @"");
}
...
- (UIImage*)applyEffect:(UIImage*)image
{
    ...
    [stillImageFilter setCrossHatchSpacing:_shadowSlider.value];
    [stillImageFilter setLineWidth:_radiusSlider.value];
...
{
    _shadowSlider = [self sliderWithValue:0.05 minimumValue:0.01 maximumValue:0.1];
    _shadowSlider.superview.center = CGPointMake(_containerView.width/2, _containerView.height-30);
    
    _radiusSlider = [self sliderWithValue:0.005 minimumValue:0.001 maximumValue:0.01];
