...
#import "CLHalftoneEffect.h"

#import "UIView+Frame.h"

@implementation CLHalftoneEffect
{
...
{
    return NSLocalizedStringWithDefaultValue(@"CLHalftoneEffect_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Halftone", @"");
}
...
- (UIImage*)applyEffect:(UIImage*)image
{
    ...
    GPUImageHalftoneFilter *stillImageFilter = [[GPUImageHalftoneFilter alloc] init];
...
{
    _shadowSlider = [self sliderWithValue:0.01 minimumValue:0.001 maximumValue:0.1];
