...
#import "CLSplashEffect.h"
#import "UIView+Frame.h"

@interface CLSplashCircle : UIView
@property (nonatomic, strong) UIColor *color;
@end

@interface CLSplashEffect()
<UIGestureRecognizerDelegate>
@end

@implementation CLSplashEffect
{
    UIView *_containerView;
    UIView *_container;
    CLSplashCircle *_circleView;
    UILabel* circleLabel;
...
{
    return NSLocalizedStringWithDefaultValue(@"CLSplashEffect_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Radiation", @"");
}
...
- (UIImage*)applyEffect:(UIImage*)image
{
    ...
    [filter setValue:[NSNumber numberWithFloat:_R*(_Distortion/2)] forKey:@"inputRadius"];
...
- (void)setUserInterface
{
    ...
    _circleView = [[CLSplashCircle alloc] init];
