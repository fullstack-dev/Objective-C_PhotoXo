...
#import "CLHazeEffect.h"

#import "UIView+Frame.h"

@implementation CLHazeEffect
{
...
{
    return NSLocalizedStringWithDefaultValue(@"CLHazeEffect_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Haze", @"");
}
...
- (UIImage*)applyEffect:(UIImage*)image
{
    ...
    [stillImageFilter setDistance:_shadowSlider.value];
    [stillImageFilter setSlope:_radiusSlider.value];
...
{
    _shadowSlider = [self sliderWithValue:-0.5 minimumValue:-1 maximumValue:0.5];
