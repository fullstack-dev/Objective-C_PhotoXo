//
//  CLPointillizeEffect.m
//
//  Created by Kevin Siml - Appzer.de on 2015/10/23.
//  Copyright (c) 2015 Appzer.de. All rights reserved.
//

#import "CLPointillizeEffect.h"

#import "UIView+Frame.h"

@implementation CLPointillizeEffect
{
...
{
    return NSLocalizedStringWithDefaultValue(@"CLPointillizeEffect_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Pointillize", @"");
}
...
- (void)setUserInterface
{
     ...
     _sizeSlider = [self sliderWithValue:100 minimumValue:1 maximumValue:360];
