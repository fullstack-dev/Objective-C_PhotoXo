...
#import "CLCartoonEffect.h"

#import "UIView+Frame.h"

@implementation CLCartoonEffect
{
...
{
    return NSLocalizedStringWithDefaultValue(@"CLComicEffect_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Comic", @"");
}
...
{
    /*
     _sizeSlider = [self sliderWithValue:2500 minimumValue:1 maximumValue:8000];
...
- (void)sliderDidChange:(UISlider*)sender
{
    ...
    if ([nowCall timeIntervalSinceDate:lastCallSlider] > 0.05) {
