...
#import "CLEdgeWorkEffect.h"

#import "UIView+Frame.h"

@implementation CLEdgeWorkEffect
{
...
{
    return NSLocalizedStringWithDefaultValue(@"CLEdgeWorkEffect_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Edge Work", @"");
}
...
- (void)setUserInterface
{
     ...
     _sizeSlider = [self sliderWithValue:5 minimumValue:1 maximumValue:25];
