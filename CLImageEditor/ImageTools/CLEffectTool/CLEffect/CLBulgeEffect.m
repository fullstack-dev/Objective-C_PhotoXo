...
#import "CLBulgeEffect.h"
#import "UIView+Frame.h"

@interface CLBulgeCircle : UIView
@property (nonatomic, strong) UIColor *color;
@end

@interface CLBulgeEffect()
<UIGestureRecognizerDelegate>
@end

@implementation CLBulgeEffect
{
    UIView *_containerView;
    UIView *_container;
    CLBulgeCircle *_circleView;
    UILabel* circleLabel;
...
{
    return NSLocalizedStringWithDefaultValue(@"CLBulgeEffect_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Bulge", @"");
}
...
- (void)setUserInterface
{
    ...
    _circleView = [[CLBulgeCircle alloc] init];
