...
#import "CLZoomBlurEffect.h"
#import "UIView+Frame.h"

@interface CLZoomBlurCircle : UIView
@property (nonatomic, strong) UIColor *color;
@end

@interface CLZoomBlurEffect()
<UIGestureRecognizerDelegate>
@end

@implementation CLZoomBlurEffect
{
    UIView *_containerView;
    UIView *_container;
    CLZoomBlurCircle *_circleView;
    UILabel* circleLabel;
...
{
    return NSLocalizedStringWithDefaultValue(@"CLZoomBlurEffect_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Zoom Blur", @"");
}
...
- (void)setUserInterface
{
    ...
    _circleView = [[CLZoomBlurCircle alloc] init];
...
@implementation CLZoomBlurCircle
