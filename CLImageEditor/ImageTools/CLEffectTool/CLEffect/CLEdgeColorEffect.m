...
#import "CLEdgeColorEffect.h"

#import "UIView+Frame.h"

@implementation CLEdgeColorEffect
{
...
{
    return NSLocalizedStringWithDefaultValue(@"CLEdgeColorEffect_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Edge Color", @"");
}
...
- (UIImage*)applyEffect:(UIImage*)image
{
    ...
    [filter setValue:[NSNumber numberWithFloat:(int)_sizeSlider.value] forKey:@"inputIntensity"];
...
- (void)setUserInterface
{
     ...
     _sizeSlider = [self sliderWithValue:40 minimumValue:5 maximumValue:100];
