...
#import "CLHatchEffect.h"

#import "UIImage+Utility.h"
#import "UIView+Frame.h"

@implementation CLHatchEffect
{
...
{
    return NSLocalizedStringWithDefaultValue(@"CLHatchEffect_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Hatch", @"");
}
