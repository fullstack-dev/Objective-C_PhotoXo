...
#import "CLSepiaEffect.h"

#import "UIView+Frame.h"

@implementation CLSepiaEffect
{
...
{
    return NSLocalizedStringWithDefaultValue(@"CLDefaultSepiaFilter_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Sepia", @"");
}
...
{
    _shadowSlider = [self sliderWithValue:1 minimumValue:0 maximumValue:1];
