...
#import "CLOilEffect.h"

#import "UIView+Frame.h"

@implementation CLOilEffect
{
    ...
    GPUImageKuwaharaFilter *stillImageFilter;
}
...
{
    return NSLocalizedStringWithDefaultValue(@"CLOilEffect_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Oil", @"");
}
...
{
    [stillImageFilter setRadius:_shadowSlider.value];
...
{
    _shadowSlider = [self sliderWithValue:3 minimumValue:0 maximumValue:4];
