...
#import "CLSketchEffect.h"

#import "UIView+Frame.h"

@implementation CLSketchEffect
{
...
{
    return NSLocalizedStringWithDefaultValue(@"CLSketchEffect_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Sketch", @"");
}
...
{
    _shadowSlider = [self sliderWithValue:5 minimumValue:0.1 maximumValue:10];
