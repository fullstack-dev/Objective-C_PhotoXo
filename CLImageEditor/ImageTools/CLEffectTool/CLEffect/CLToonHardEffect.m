...
#import "CLToonHardEffect.h"

#import "UIView+Frame.h"

@implementation CLToonHardEffect
{
...
{
    return NSLocalizedStringWithDefaultValue(@"CLToonHardEffect_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Toon Hard", @"");
}
