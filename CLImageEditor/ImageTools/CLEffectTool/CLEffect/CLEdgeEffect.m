...
#import "CLEdgeEffect.h"

#import "UIView+Frame.h"

@implementation CLEdgeEffect
{
...
{
    return NSLocalizedStringWithDefaultValue(@"CLEdgeEffect_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Sharpen", @"");
}
...
{
    _shadowSlider = [self sliderWithValue:1 minimumValue:0.1 maximumValue:3];
