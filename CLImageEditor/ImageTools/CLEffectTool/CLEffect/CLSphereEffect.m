...
#import "CLSphereEffect.h"
#import "UIView+Frame.h"

@interface CLSphereCircle : UIView
@property (nonatomic, strong) UIColor *color;
@end

@interface CLSphereEffect()
<UIGestureRecognizerDelegate>
@end

@implementation CLSphereEffect
{
    UIView *_containerView;
    UIView *_container;
    CLSphereCircle *_circleView;
    UILabel* circleLabel;
...
{
    return NSLocalizedStringWithDefaultValue(@"CLSphereEffect_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Sphere", @"");
}
...
{
    CGFloat R = (_R + 0.1);
    GPUImageSphereRefractionFilter *stillImageFilter = [[GPUImageSphereRefractionFilter alloc] init];
...
- (void)setUserInterface
{
    ...
    _circleView = [[CLSphereCircle alloc] init];
