...
#import "CLOpacityEffect.h"

#import "UIView+Frame.h"

@implementation CLOpacityEffect
{
...
{
    return NSLocalizedStringWithDefaultValue(@"CLOpacityEffect_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Opacity", @"");
}
...
- (UIImage*)applyEffect:(UIImage*)image
{
    ...
    [stillImageFilter setOpacity:_shadowSlider.value];
