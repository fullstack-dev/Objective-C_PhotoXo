...
#import "CLEmbossEffect.h"

#import "UIView+Frame.h"

@implementation CLEmbossEffect
{
...
{
    return NSLocalizedStringWithDefaultValue(@"CLEmbossEffect_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Emboss", @"");
}
...
{
    _shadowSlider = [self sliderWithValue:2 minimumValue:0 maximumValue:4];
