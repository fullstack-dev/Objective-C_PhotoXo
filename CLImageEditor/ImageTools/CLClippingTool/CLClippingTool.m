...
//  CLClippingTool.m
//
//  Created by Kevin Siml - Appzer.de on 2015/10/18.
...
+ (NSArray*)defaultPresetRatios
{
    return @[
             ...
             @{kCLClippingToolRatioValue1:@21, kCLClippingToolRatioValue2:@9, kCLClippingToolRatioTitleFormat:@"%g : %g"},
             ];
}
...
- (void)setup
{
    ...
    if(!swapBtnHidden){
        ...
        btn.frame = CGRectMake(0, 0, 51, 51);
        btn.center = CGPointMake(btnPanel.width/2, btnPanel.height/2 - 5);
