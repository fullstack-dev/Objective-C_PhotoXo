...
#import "CLRedGreen3D.h"

#import "UIView+Frame.h"

@implementation CLRedGreen3D
{
...
{
    return NSLocalizedStringWithDefaultValue(@"CLRedGreen3D_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Red-Green", @"");
}
