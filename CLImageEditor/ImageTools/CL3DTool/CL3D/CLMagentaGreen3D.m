...
#import "CLMagentaGreen3D.h"

#import "UIView+Frame.h"

@implementation CLMagentaGreen3D
{
...
{
    return NSLocalizedStringWithDefaultValue(@"CLMagentaGreen3D_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Magenta-Green", @"");
}
