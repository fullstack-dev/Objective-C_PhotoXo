...
#import "CLBlueRed3D.h"

#import "UIView+Frame.h"

@implementation CLBlueRed3D
{
...
{
    return NSLocalizedStringWithDefaultValue(@"CLBlueRed3D_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Blue-Red", @"");
}
