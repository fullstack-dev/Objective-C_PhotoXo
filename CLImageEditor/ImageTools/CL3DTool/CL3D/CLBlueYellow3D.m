...
#import "CLBlueYellow3D.h"

#import "UIView+Frame.h"

@implementation CLBlueYellow3D
{
...
{
    return NSLocalizedStringWithDefaultValue(@"CLBlueYellow3D_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Blue-Yellow", @"");
}
