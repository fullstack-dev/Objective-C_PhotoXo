...
#import "CLCyanRed3D.h"

#import "UIView+Frame.h"

@implementation CLCyanRed3D
{
...
{
    return NSLocalizedStringWithDefaultValue(@"CLCyanRed3D_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Cyan-Red", @"");
}
