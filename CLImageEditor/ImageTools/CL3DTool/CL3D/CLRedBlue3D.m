...
#import "CLRedBlue3D.h"

#import "UIView+Frame.h"

@implementation CLRedBlue3D
{
...
{
    return NSLocalizedStringWithDefaultValue(@"CLRedBlue3D_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Red-Blue", @"");
}
