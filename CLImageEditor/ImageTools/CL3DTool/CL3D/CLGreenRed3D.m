...
#import "CLGreenRed3D.h"

#import "UIView+Frame.h"

@implementation CLGreenRed3D
{
...
{
    return NSLocalizedStringWithDefaultValue(@"CLGreenRed3D_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Green-Red", @"");
}
