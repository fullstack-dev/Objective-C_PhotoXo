...
#import "CLRedCyan3D.h"

#import "UIView+Frame.h"

@implementation CLRedCyan3D
{
...
{
    return NSLocalizedStringWithDefaultValue(@"CLRedCyan3D_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Red-Cyan", @"");
}
