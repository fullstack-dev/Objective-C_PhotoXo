...
@property (nonatomic, strong) CL3DBase *selectedEffect;
@end


@implementation CL3DTool
{
...
+ (NSArray*)subtools
{
    return [CLImageToolInfo toolsWithToolClass:[CL3DBase class]];
}

+ (NSString*)defaultTitle
{
    return NSLocalizedStringWithDefaultValue(@"CL3DTool_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Anaglyph", @"");
}
...
- (void)setup
{
    ...
    _menuScroll = [[UIScrollView alloc] initWithFrame:CGRectMake(self.editor.menuView.frame.origin.x, self.editor.menuView.frame.origin.y+10, self.editor.menuView.frame.size.width, self.editor.menuView.frame.size.height-10)];
...
- (void)setSelectedEffect:(CL3DBase *)selectedEffect
{
