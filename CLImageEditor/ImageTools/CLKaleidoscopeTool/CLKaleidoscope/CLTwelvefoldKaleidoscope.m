//
//  CLTwelvefoldTileKaleidoscope.m
//
//  Created by Kevin Siml - Appzer.de on 2015/10/23.
//  Copyright (c) 2015 Appzer.de. All rights reserved.
//

#import "CLTwelvefoldKaleidoscope.h"

#import "UIView+Frame.h"

@implementation CLTwelvefoldTileKaleidoscope
{
...
{
    return NSLocalizedStringWithDefaultValue(@"CLTwelvefoldTileKaleidoscope_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Twelvefold", @"");
}
...
{
    filter = [CIFilter filterWithName:@"CITwelvefoldReflectedTile"];
