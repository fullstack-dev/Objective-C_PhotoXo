//
//  CLFourfoldTileKaleidoscope.m
//
//  Created by Kevin Siml - Appzer.de on 2015/10/23.
//  Copyright (c) 2015 Appzer.de. All rights reserved.
//

#import "CLFourfoldKaleidoscope.h"

#import "UIView+Frame.h"

@implementation CLFourfoldTileKaleidoscope
{
...
{
    return NSLocalizedStringWithDefaultValue(@"CLFourfoldTileKaleidoscope_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Fourfold", @"");
}
...
{
    filter = [CIFilter filterWithName:@"CIFourfoldReflectedTile"];
