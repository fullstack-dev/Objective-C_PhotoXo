//
//  CLSixtfoldReflectedTileKaleidoscope.m
//
//  Created by Kevin Siml - Appzer.de on 2015/10/23.
//  Copyright (c) 2015 Appzer.de. All rights reserved.
//

#import "CLSixtfoldReflectedTileKaleidoscope.h"

#import "UIView+Frame.h"

@implementation CLSixtfoldReflectedTileKaleidoscope
{
...
{
    return NSLocalizedStringWithDefaultValue(@"CLSixtfoldReflectedTileKaleidoscope_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Sixfold Reflected Tile", @"");
}
...
{
    filter = [CIFilter filterWithName:@"CISixfoldReflectedTile"];
