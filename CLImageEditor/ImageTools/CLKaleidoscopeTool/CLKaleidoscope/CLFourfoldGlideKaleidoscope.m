//
//  CLFourfoldGlideTileKaleidoscope.m
//
//  Created by Kevin Siml - Appzer.de on 2015/10/23.
//  Copyright (c) 2015 Appzer.de. All rights reserved.
//

#import "CLFourfoldGlideKaleidoscope.h"

#import "UIView+Frame.h"

@implementation CLFourfoldGlideTileKaleidoscope
{
...
{
    return NSLocalizedStringWithDefaultValue(@"CLFourfoldGlideTileKaleidoscope_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Fourfold Rotation", @"");
}
...
{
    filter = [CIFilter filterWithName:@"CIGlideReflectedTile"];
