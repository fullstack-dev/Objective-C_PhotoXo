//
//  CLSixtfoldRotatedTileKaleidoscope.m
//
//  Created by Kevin Siml - Appzer.de on 2015/10/23.
//  Copyright (c) 2015 Appzer.de. All rights reserved.
//

#import "CLSixtfoldRotatedTileKaleidoscope.h"

#import "UIView+Frame.h"

@implementation CLSixtfoldRotatedTileKaleidoscope
{
...
{
    return NSLocalizedStringWithDefaultValue(@"CLSixtfoldRotatedTileKaleidoscope_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Sixfold Rotateded Tile", @"");
}
...
{
    filter = [CIFilter filterWithName:@"CISixfoldRotatedTile"];
