//
//  CLFourfoldTransTileKaleidoscope.m
//
//  Created by Kevin Siml - Appzer.de on 2015/10/23.
//  Copyright (c) 2015 Appzer.de. All rights reserved.
//

#import "CLFourfoldTransKaleidoscope.h"

#import "UIView+Frame.h"

@implementation CLFourfoldTransTileKaleidoscope
{
...
{
    return NSLocalizedStringWithDefaultValue(@"CLFourfoldTransTileKaleidoscope_DefaultTitle", nil, [CLImageEditorTheme bundle], @"FourfoldTrans", @"");
}
...
{
    filter = [CIFilter filterWithName:@"CIFourfoldTranslatedTile"];
    ...
    [filter setValue:[NSNumber numberWithDouble:_decaySlider.value] forKey:@"inputAcuteAngle"];
...
{
    _sizeSlider = [self sliderWithValue:1000 minimumValue:10 maximumValue:3000];
    _sizeSlider.superview.center = CGPointMake(_containerView.width/2, _containerView.height-30);
    
    _rotationSlider = [self sliderWithValue:0 minimumValue:-3.14 maximumValue:3.14];
    ...
    _decaySlider = [self sliderWithValue:1.5 minimumValue:-3.14 maximumValue:3.14];
