//
//  CLTriangleTileKaleidoscope.m
//
//  Created by Kevin Siml - Appzer.de on 2015/10/23.
//  Copyright (c) 2015 Appzer.de. All rights reserved.
//

#import "CLTriangleTileKaleidoscope.h"

#import "UIView+Frame.h"

@implementation CLTriangleTileKaleidoscope
{
...
{
    return NSLocalizedStringWithDefaultValue(@"CLTriangleTileKaleidoscope_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Tile Triangle", @"");
}
...
{
    _sizeSlider = [self sliderWithValue:1250 minimumValue:10 maximumValue:2500];
