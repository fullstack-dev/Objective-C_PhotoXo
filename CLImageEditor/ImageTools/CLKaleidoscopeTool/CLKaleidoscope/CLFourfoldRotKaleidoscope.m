//
//  CLFourfoldRotTileKaleidoscope.m
//
//  Created by Kevin Siml - Appzer.de on 2015/10/23.
//  Copyright (c) 2015 Appzer.de. All rights reserved.
//

#import "CLFourfoldRotKaleidoscope.h"

#import "UIView+Frame.h"

@implementation CLFourfoldRotTileKaleidoscope
{
...
{
    return NSLocalizedStringWithDefaultValue(@"CLFourfoldRotTileKaleidoscope_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Fourfold Rotation", @"");
}
...
{
    filter = [CIFilter filterWithName:@"CIFourfoldRotatedTile"];
