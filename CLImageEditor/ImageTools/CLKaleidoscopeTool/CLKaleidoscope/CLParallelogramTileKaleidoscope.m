//
//  CLParallelogramTileTileKaleidoscope.m
//
//  Created by Kevin Siml - Appzer.de on 2015/10/23.
//  Copyright (c) 2015 Appzer.de. All rights reserved.
//

#import "CLParallelogramTileKaleidoscope.h"

#import "UIView+Frame.h"

@implementation CLParallelogramTileKaleidoscope
{
...
{
    return NSLocalizedStringWithDefaultValue(@"CLParallelogramTileKaleidoscope_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Parallelogram Tile", @"");
}
...
{
    _sizeSlider = [self sliderWithValue:800 minimumValue:10 maximumValue:3000];
    ...
    _decaySlider = [self sliderWithValue:1.5 minimumValue:0.01 maximumValue:10];
