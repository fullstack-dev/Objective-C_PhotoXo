//
//  CLEightfoldTileKaleidoscope.m
//
//  Created by Kevin Siml - Appzer.de on 2015/10/23.
//  Copyright (c) 2015 Appzer.de. All rights reserved.
//

#import "CLEightfoldKaleidoscope.h"

#import "UIView+Frame.h"

@implementation CLEightfoldTileKaleidoscope
{
...
{
    return NSLocalizedStringWithDefaultValue(@"CLEightfoldTileKaleidoscope_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Eightfold", @"");
}
...
{
    filter = [CIFilter filterWithName:@"CIEightfoldReflectedTile"];
