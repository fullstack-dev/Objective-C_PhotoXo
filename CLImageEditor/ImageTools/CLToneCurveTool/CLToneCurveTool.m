...
- (UIImage*)filteredImage:(UIImage*)image
{
    ...
    NSLog(@"P1 %@", _tonecurveView.point0);
    NSLog(@"P2 %@", _tonecurveView.point1);
    NSLog(@"P3 %@", _tonecurveView.point2);
    NSLog(@"P4 %@", _tonecurveView.point3);
    NSLog(@"P5 %@", _tonecurveView.point4);
