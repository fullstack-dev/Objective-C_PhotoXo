//
//  CLHorizontalTrible2Mirror.m
//
//  Created by Kevin Siml - Appzer.de on 2015/10/23.
//  Copyright (c) 2015 Appzer.de. All rights reserved.
//

#import "CLHorizontalTrible2Mirror.h"
#import "UIView+Frame.h"

@interface CLHorizontalTrible2CircleMirror : UIView
@property (nonatomic, strong) UIColor *color;
@end

@interface CLHorizontalTrible2Mirror()
<UIGestureRecognizerDelegate>
@end

@implementation CLHorizontalTrible2Mirror
{
    UIView *_containerView;
    UIView *_container;
    CLHorizontalTrible2CircleMirror *_circleView;
    UILabel* circleLabel;
...
- (UIImage*)applyMirror:(UIImage*)image
{
    ...
    middleImage = [UIImage imageWithCGImage:upperImage.CGImage scale:upperImage.scale orientation:UIImageOrientationUp];
...
- (void)setUserInterface
{
    ...
    _circleView = [[CLHorizontalTrible2CircleMirror alloc] init];
...
@implementation CLHorizontalTrible2CircleMirror
