...
#import "CLVertical2Mirror.h"
#import "UIView+Frame.h"

@interface CLVertical2CircleMirror : UIView
@property (nonatomic, strong) UIColor *color;
@end

@interface CLVertical2Mirror()
<UIGestureRecognizerDelegate>
@end

@implementation CLVertical2Mirror
{
    UIView *_containerView;
    UIView *_container;
    CLVertical2CircleMirror *_circleView;
    UILabel* circleLabel;
...
- (void)setUserInterface
{
    ...
    _circleView = [[CLVertical2CircleMirror alloc] init];
...
@implementation CLVertical2CircleMirror
