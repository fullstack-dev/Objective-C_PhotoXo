//
//  CLVerticalTribleMirror.m
//
//  Created by Kevin Siml - Appzer.de on 2015/10/23.
//  Copyright (c) 2015 Appzer.de. All rights reserved.
//

#import "CLVerticalTribleMirror.h"
#import "UIView+Frame.h"

@interface CLVerticalTribleCircleMirror : UIView
@property (nonatomic, strong) UIColor *color;
@end

@interface CLVerticalTribleMirror()
<UIGestureRecognizerDelegate>
@end

@implementation CLVerticalTribleMirror
{
    UIView *_containerView;
    UIView *_container;
    CLVerticalTribleCircleMirror *_circleView;
    UILabel* circleLabel;
...
- (UIImage*)applyMirror:(UIImage*)image
{
    ...
    middleImage = [UIImage imageWithCGImage:leftImage.CGImage scale:leftImage.scale orientation:UIImageOrientationUpMirrored];
    [middleImage drawInRect:CGRectMake((newSize.width/3)-1,0,newSize.width/3+1,newSize.height)];
    
    rightImage = [UIImage imageWithCGImage:leftImage.CGImage scale:leftImage.scale orientation:UIImageOrientationUp];
...
- (void)setUserInterface
{
    ...
    _circleView = [[CLVerticalTribleCircleMirror alloc] init];
...
@implementation CLVerticalTribleCircleMirror
