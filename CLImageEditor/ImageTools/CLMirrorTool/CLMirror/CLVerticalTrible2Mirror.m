//
//  CLVerticalTrible2Mirror.m
//
//  Created by Kevin Siml - Appzer.de on 2015/10/23.
//  Copyright (c) 2015 Appzer.de. All rights reserved.
//

#import "CLVerticalTrible2Mirror.h"
#import "UIView+Frame.h"

@interface CLVerticalTrible2CircleMirror : UIView
@property (nonatomic, strong) UIColor *color;
@end

@interface CLVerticalTrible2Mirror()
<UIGestureRecognizerDelegate>
@end

@implementation CLVerticalTrible2Mirror
{
    UIView *_containerView;
    UIView *_container;
    CLVerticalTrible2CircleMirror *_circleView;
    UILabel* circleLabel;
...
- (UIImage*)applyMirror:(UIImage*)image
{
    ...
    CGRect cropRect = CGRectMake (_X*2*(image.size.width/3), 0.0, image.size.width/3, image.size.height);
    ...
    leftImage = [UIImage imageWithCGImage:leftImage.CGImage scale:leftImage.scale orientation:UIImageOrientationUpMirrored];
    [leftImage drawInRect:CGRectMake(0,0,newSize.width/3,newSize.height)];
    
    middleImage = [UIImage imageWithCGImage:leftImage.CGImage scale:leftImage.scale orientation:UIImageOrientationUp];
    [middleImage drawInRect:CGRectMake((newSize.width/3)-1,0,(newSize.width/3)+1,newSize.height)];
    
    rightImage = [UIImage imageWithCGImage:leftImage.CGImage scale:leftImage.scale orientation:UIImageOrientationUpMirrored];
    [rightImage drawInRect:CGRectMake((newSize.width/1.5)-1,0,(newSize.width/3)+1,newSize.height)];
...
- (void)setUserInterface
{
    ...
    _circleView = [[CLVerticalTrible2CircleMirror alloc] init];
...
@implementation CLVerticalTrible2CircleMirror
