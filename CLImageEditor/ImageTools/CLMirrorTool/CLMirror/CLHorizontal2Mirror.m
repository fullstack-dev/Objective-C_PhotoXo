//
//  CLHorizontal2Mirror.m
//
//  Created by Kevin Siml - Appzer.de on 2015/10/23.
//  Copyright (c) 2015 Appzer.de. All rights reserved.
//

#import "CLHorizontal2Mirror.h"
#import "UIView+Frame.h"

@interface CLHorizontal2CircleMirror : UIView
@property (nonatomic, strong) UIColor *color;
@end

@interface CLHorizontal2Mirror()
<UIGestureRecognizerDelegate>
@end

@implementation CLHorizontal2Mirror
{
    UIView *_containerView;
    UIView *_container;
    CLHorizontal2CircleMirror *_circleView;
    UILabel* circleLabel;
...
- (void)setUserInterface
{
    ...
    _circleView = [[CLHorizontal2CircleMirror alloc] init];
...
@implementation CLHorizontal2CircleMirror
