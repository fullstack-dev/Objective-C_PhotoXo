...
- (void)setBlurMenu
{
    ...
    NSArray *_menu = @[
                       ...
                       @{@"title":NSLocalizedStringWithDefaultValue(@"CLBlurEffect_MenuItemCircle", nil, [CLImageEditorTheme bundle], @"Circle", @""), @"icon":[CLImageEditorTheme imageNamed:[self class] image:@"btn_circle.png"]},
