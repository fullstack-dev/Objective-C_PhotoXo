...
- (void)setMenu
{
    ...
    /*_opacitySlider = [self defaultSliderWithWidth:_colorSlider.width];
    _opacitySlider.left = 10;
    _opacitySlider.top = _widthSlider.bottom - 7;
    [_opacitySlider addTarget:self action:@selector(opacitySliderDidChange:) forControlEvents:UIControlEventValueChanged];
    _opacitySlider.value = 1;
    _opacitySlider.backgroundColor = [UIColor colorWithPatternImage:[self widthSliderBackground]];
    //[_opacitySlider setThumbImage:[CLImageEditorTheme imageNamed:[self class] image:@"opacity"] forState:UIControlStateNormal];
    //[_opacitySlider setThumbImage:[CLImageEditorTheme imageNamed:[self class] image:@"opacity"] forState:UIControlStateHighlighted];
    [_menuView addSubview:_opacitySlider];*/
    ...
    _strokePreview.center = CGPointMake(_menuView.width-W/2-4, _menuView.height/2-7);
    ...
    //[self opacitySliderDidChange:_widthSlider];
...
/*- (void)opacitySliderDidChange:(UISlider*)sender
{
    _strokePreview.alpha = _opacitySlider.value;
}*/
...
-(void)drawLine:(CGPoint)from to:(CGPoint)to
{
    ...
    //UIColor *strokeColor2 = [strokeColor colorWithAlphaComponent:_opacitySlider.value];
