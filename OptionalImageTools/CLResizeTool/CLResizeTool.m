...
//  CLResizeTool.m
//
//  Created by Kevin Siml - Appzer.de on 2015/12/12.
...
- (void)setup
{
    ...
    _switchBtn = [CLImageEditorTheme menuItemWithFrame:CGRectMake(0, 0, 71, 71) target:self action:@selector(pushedSwitchBtn:) toolInfo:nil];
    _switchBtn.center = CGPointMake(btnPanel.width/2, btnPanel.height/2 - 5);
...
- (void)initInfoPanel
{
    ...
    */
    ...
    _fieldH = [[UITextField alloc] initWithFrame:CGRectMake(_chainBtn.right + 2, y+5, 100, 40)];
