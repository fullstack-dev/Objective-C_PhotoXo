...
- (void)setMenu
{
    ...
    NSArray *_menu = @[
                       ...
                       @{@"title":NSLocalizedStringWithDefaultValue(@"CLTextTool_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Text", @""), @"icon":[CLImageEditorTheme imageNamed:[self class]
																																												  image:@"icon.png"]},
...
- (void) openSheetText
{
    if(_imageDate.length>0 || _imageLocation.length>0){
        UIActionSheet *sheet = [[UIActionSheet alloc] initWithTitle:nil delegate:self cancelButtonTitle:NSLocalizedString(@"TXT_Cancel", nil) destructiveButtonTitle:nil otherButtonTitles:NSLocalizedString(@"CLImageEditor_Text", nil), NSLocalizedString(@"CLImageEditor_DateLocation", nil), nil];
...
- (void)addNewText
{
    ...
    if(TextWithDateLoc==TRUE){
        ...
        view.font = [UIFont fontWithName:@"Helvetica"size:10];
...
- (id)init
{
    ...
    if(self){
        ...
        _label.minimumScaleFactor = 0.02;
        ...
        [_mirrorButton setImage:[CLImageEditorTheme imageNamed:[CLTextTool class] image:@"btn_mirror.png"] forState:UIControlStateNormal];
...
- (void)setText:(NSString *)text
{
    if(![text isEqualToString:_text]){
        _text = text;
        _label.text = (_text.length>0) ? _text : NSLocalizedStringWithDefaultValue(@"CLTextTool_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Text", @"");
    }
}
...
- (void)circleViewDidPan:(UIPanGestureRecognizer*)sender
{
    ...
    [self setScale:MAX(_initialScale * R / tmpR, (_MaininitialScale*0.5))];
}
